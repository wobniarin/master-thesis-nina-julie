...
# Prepare data and calculate NMAE for each model
results = []
for predicted_file, target_file in target_predicted_files.items():
    ...
    power_type = 'solar'  # Change as necessary
    ...
    results.append((zone_key, nmae_predicted, nmae_naive))

# Plotting results
for zone, nmae_pred, nmae_naive in results:
